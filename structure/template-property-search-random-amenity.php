    ...
    <div class="glass-blur container-fluid">
      ...
      <div class="form-wrapper">
        <form id="propertyForm" class="row g-3 align-self">
          ...
          <div class="col-md-5">
            <input type="text" name="keywords" class="form-control" id="keywordInput" placeholder="Enter keywords (e.g., villa, 3BHK)"/>
          </div>
          <div class="col-md-2">
...
<script>
  ...
  // Helper: Generate random pastel color for badges
          ...
          ${prop.amenities && prop.amenities.length > 0 ? `
            <div class="mb-2 d-flex flex-wrap gap-2">
              ${prop.amenities.map(amenity => {
                ...
                return `<span class="badge text-dark" style="background-color: ${randomColor};">${amenity}</span>`;
              }).join('')}
            </div>
