...
/**
 * Single Property Template (with Theme Layout)
 */

get_header();

// Fetch layout and sidebar settings from your theme options
$data = \buildexo\Includes\Classes\Common::instance()->data('single')->get();
$layout = $data->get('layout');
$sidebar = $data->get('sidebar');

// Check if the sidebar is active, and adjust the layout
...
// Adjust class for content side based on layout
...
<head>
    ...
    <title><?php the_title(); ?> - Property Details</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">

    <style>
        /* Custom styles for the property page */
        body {
            padding-top: 200px;
        ...
        .property-details .main-media-viewer img,
        .property-details .main-media-viewer video {
            max-width: 100%;
        }
        ...
        <article class="property-details">
            <header class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="bg-white p-3 rounded shadow-sm">
                        ...
                        <div class="d-flex flex-wrap gap-3 justify-content-center mt-3" id="thumbnailContainer">
                            <?php
                            // Display image thumbnails only
                            if ($media) {
                                foreach ($media as $index => $item) {
                                    // Display Image Thumbnail
                                    echo '<div class="thumbnail" data-index="' . esc_attr($index) . '" data-src="' . esc_url($item) . '" style="width: 100px; height: 100px; overflow: hidden; margin: 5px;">';
                    ...
                    <section class="bg-white p-4 rounded shadow-sm">
                        ...
                        <ul class="list-unstyled small">
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Bedrooms:</span><span><?php echo get_post_meta(get_the_ID(), 'bedrooms', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Bathrooms:</span><span><?php echo get_post_meta(get_the_ID(), 'bathrooms', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Balconies:</span><span><?php echo get_post_meta(get_the_ID(), 'balconies', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Area:</span><span><?php echo get_post_meta(get_the_ID(), 'area', true); ?> sq. ft.</span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Floor:</span><span><?php echo get_post_meta(get_the_ID(), 'floor', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Furnishing:</span><span><?php echo get_post_meta(get_the_ID(), 'furnishing', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Facing:</span><span><?php echo get_post_meta(get_the_ID(), 'facing', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Maintenance:</span><span><?php echo get_post_meta(get_the_ID(), 'maintenance', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">Ownership:</span><span><?php echo get_post_meta(get_the_ID(), 'ownership', true); ?></span>
                            </li>
                            <li class="d-flex justify-content-between border-bottom py-1">
                                <span class="fw-semibold text-muted">RERA Registered:</span><span><?php
                            ...
                            <li class="d-flex justify-content-between py-1">
                                <span class="fw-semibold text-muted">Construction Status:</span><span><?php echo get_post_meta(get_the_ID(), 'construction_status', true); ?></span>
                            </li>
                        </ul>
                    </section>
                </div>
                ...
                <ul class="list-inline">
                    ...
                    if ($amenities && !is_wp_error($amenities)) {
                        foreach ($amenities as $amenity) {
                            echo '<li class="list-inline-item badge bord bg-light text-primary fw-semibold me-2 mb-2">' . esc_html($amenity->name) . '</li>';
                        }
                    }
                    ?>
                </ul>
                ...
                <ul class="list-inline">
                    ...
                    if ($interior_details && !is_wp_error($interior_details)) {
                        foreach ($interior_details as $detail) {
                            echo '<li class="list-inline-item badge bord bg-light text-primary fw-semibold me-2 mb-2">' . esc_html($detail->name) . '</li>';
                        }
                    }
                    ?>
                </ul>
                ...
                <ul class="list-inline">
                    ...
                    if ($smart_home_features && !is_wp_error($smart_home_features)) {
                        foreach ($smart_home_features as $feature) {
                            echo '<li class="list-inline-item badge bord bg-light text-primary fw-semibold me-2 mb-2">' . esc_html($feature->name) . '</li>';
                        }
                    }
                    ?>
                </ul>
                ...
                <ul class="list-inline ">
                    ...
                    if ($loan_options && !is_wp_error($loan_options)) {
                        foreach ($loan_options as $loan) {
                            echo '<li class="list-inline-item badge bord bg-light text-primary fw-semibold me-2 mb-2">' . esc_html($loan->name) . '</li>';
                        }
                    }
                    ?>
                </ul>
            ...
            <section class="container-fluid text-center sticky-bottom py-3 bg-white border-top shadow-sm mb-5">
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="tel:<?php echo esc_attr(get_post_meta(get_the_ID(), 'contact_seller', true)); ?>" class="btn btn-primary px-4" style="width:150px;">Contact Seller</a>
